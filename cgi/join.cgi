...
REQUEST_DESTINATION_EMAIL = 'nikdoof@dimension.sh'
...
def error(msg):
    sys.stdout.write('\n')
    sys.stdout.write('<meta http-equiv="refresh" content="3; URL=\'http://gamut.one/join.html\'"/>\n')
...
def main():
    ...
    msg['Subject'] = f'[GAMUT.ONE] New User Request - {username}'
    msg['From'] = 'nobody@gamut.one'
    ...
    sys.stdout.write('Location: http://gamut.one/join_submitted.html\n\n')
